      ...
      <div style={{ display: "flex", width: "100%", height: "100%", backgroundColor: "#081510", fontFamily: "sans-serif", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", width: 480, padding: "60px 32px 60px 72px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 24 }}>
            ...
            <span style={{ display: "flex", fontFamily: "monospace", fontSize: 11, letterSpacing: "0.16em", textTransform: "uppercase", color: "rgba(245,240,232,0.35)" }}>EV Charge Savings</span>
          </div>
          ...
          <div style={{ display: "flex", fontSize: 18, color: "rgba(245,240,232,0.48)", lineHeight: 1.55, maxWidth: 360, marginBottom: 36 }}>
            In-depth guides on EV charging costs, incentives, home setup, and making the switch from gas.
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, backgroundColor: "rgba(46,204,113,0.12)", border: "1px solid rgba(46,204,113,0.28)", borderRadius: 100, padding: "9px 18px" }}>
            ...
            <span style={{ display: "flex", fontFamily: "monospace", fontSize: 12, color: "#2ecc71", letterSpacing: "0.06em" }}>{GUIDES.length} guides</span>
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", flex: 1, padding: "48px 60px 48px 20px" }}>
          <div style={{ display: "flex", fontFamily: "monospace", fontSize: 10, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(245,240,232,0.25)", marginBottom: 20 }}>Featured guides</div>
          <div style={{ display: "flex", flexDirection: "column", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 20, overflow: "hidden", backgroundColor: "rgba(255,255,255,0.03)" }}>
            {featured.map((g, i) => (
              <div key={g.slug} style={{ display: "flex", flexDirection: "column", padding: "20px 28px", borderBottom: i < featured.length - 1 ? "1px solid rgba(255,255,255,0.07)" : "none" }}>
                <div style={{ display: "flex", fontFamily: "monospace", fontSize: 10, color: "rgba(46,204,113,0.5)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 6 }}>
                ...
                <div style={{ display: "flex", fontSize: 16, fontWeight: 600, color: "rgba(245,240,232,0.85)", lineHeight: 1.3, fontFamily: serif }}>
                  {g.title.length > 58 ? g.title.slice(0, 55) + "…" : g.title}
                </div>
              </div>
            ))}
          </div>
