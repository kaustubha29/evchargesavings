    ...
    <main className="bg-paper min-h-screen">
      <div className="section-wrap py-12 max-w-3xl">
        ...
        <div className="flex items-center gap-2 font-mono text-xs text-ink-mute mb-8">
          ...
          <span>/</span>
          <Link href="/#guides" className="hover:text-forest transition-colors">Guides</Link>
          <span>/</span>
        ...
        {/* CTA */}
        <div className="bg-ink text-cream rounded-3xl p-8 mb-12">
          ...
          <p className="text-cream/60 text-sm leading-relaxed mb-5 max-w-lg">
            Plug in your EV, your gas car, and your state — get a personalised savings estimate with real 2026 rate data.
          </p>
          <Link
            href="/#calculator"
