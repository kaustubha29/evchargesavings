...
export default async function Image() {
  ...
  // Show 3 most recent headlines as a preview
  const recent = [...NEWS]
      ...
      <div style={{ display: "flex", width: "100%", height: "100%", backgroundColor: "#081510", fontFamily: "sans-serif", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", width: 480, padding: "60px 32px 60px 72px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 24 }}>
            ...
            <span style={{ fontFamily: "monospace", fontSize: 11, letterSpacing: "0.16em", textTransform: "uppercase", color: "rgba(245,240,232,0.35)" }}>EV Charge Savings</span>
          </div>

          <div style={{ fontSize: 60, fontWeight: 700, color: "#f5f0e8", lineHeight: 1.05, letterSpacing: "-0.025em", fontFamily: serif, marginBottom: 6 }}>
            Latest
          </div>
          <div style={{ fontSize: 60, fontWeight: 700, color: "#2ecc71", lineHeight: 1.05, letterSpacing: "-0.025em", fontFamily: serif, fontStyle: "italic", marginBottom: 28 }}>
            EV News
          </div>

          <div style={{ fontSize: 18, color: "rgba(245,240,232,0.48)", lineHeight: 1.55, maxWidth: 360, marginBottom: 36 }}>
            Daily coverage of EV charging costs, incentives, new models, and charging infrastructure across the US.
          </div>

          <div style={{ display: "flex", alignItems: "center", gap: 8, backgroundColor: "rgba(46,204,113,0.12)", border: "1px solid rgba(46,204,113,0.28)", borderRadius: 100, padding: "9px 18px", width: "fit-content" }}>
            <div style={{ width: 7, height: 7, borderRadius: 4, backgroundColor: "#2ecc71", display: "flex" }} />
            <span style={{ fontFamily: "monospace", fontSize: 12, color: "#2ecc71", letterSpacing: "0.06em" }}>Updated daily</span>
          </div>
        </div>

        {/* RIGHT — recent headlines */}
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", flex: 1, padding: "48px 60px 48px 20px", gap: 0 }}>
          <div style={{ fontFamily: "monospace", fontSize: 10, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(245,240,232,0.25)", marginBottom: 20 }}>Recent stories</div>
          <div style={{ display: "flex", flexDirection: "column", gap: 0, border: "1px solid rgba(255,255,255,0.08)", borderRadius: 20, overflow: "hidden", backgroundColor: "rgba(255,255,255,0.03)" }}>
            {recent.map((a, i) => (
              <div key={a.slug} style={{ display: "flex", flexDirection: "column", padding: "20px 28px", borderBottom: i < recent.length - 1 ? "1px solid rgba(255,255,255,0.07)" : "none" }}>
                <div style={{ fontFamily: "monospace", fontSize: 10, color: "rgba(46,204,113,0.5)", letterSpacing: "0.1em", marginBottom: 6 }}>
                  {new Date(a.publishedAt + "T12:00:00Z").toLocaleDateString("en-US", { month: "short", day: "numeric" })} · {a.readTime}
                </div>
                <div style={{ fontSize: 16, fontWeight: 600, color: "rgba(245,240,232,0.85)", lineHeight: 1.3, fontFamily: serif }}>
        ...
        <div style={{ position: "absolute", bottom: 22, right: 68, fontFamily: "monospace", fontSize: 11, letterSpacing: "0.1em", color: "rgba(245,240,232,0.14)", textTransform: "uppercase", display: "flex" }}>
