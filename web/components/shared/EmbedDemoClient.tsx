...
export function EmbedDemoClient({ states }: { states: State[] }) {
  ...
  const embedCode = `<iframe src="${embedSrc}" width="100%" height="480" frameborder="0" style="border-radius:12px;border:1px solid #e5e5e5"></iframe>`;
      ...
      <div className="bg-ink text-cream">
        <div className="section-wrap py-10 max-w-4xl">
          ...
          <p className="text-cream/70 text-base max-w-xl leading-relaxed">
            Free to embed on any site. Pre-load your state and EV — readers get instant, accurate savings numbers without leaving your page.
          </p>
        </div>
      </div>
      ...
      <div className="section-wrap py-10 max-w-4xl">
          ...
          <div className="bg-white">
            ...
            <div className="px-8 py-6">
              ...
              <p className="text-sm text-[#666] mb-5">
                Use our free calculator to compare EV fuel costs vs your current gas car.
              </p>
              {/* Actual embed iframe */}
              <iframe
                key={embedSrc}
        ...
        <div className="mb-10">
          ...
          <div className="bg-ink rounded-2xl px-5 py-4 overflow-x-auto mb-3">
            <pre className="text-emerald text-xs leading-relaxed whitespace-pre-wrap break-all font-mono">
              {embedCode}
            </pre>
          </div>
          <button
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-10">
          {[
            { title: "Free forever", body: "No API key, no account, no cost. Just paste the code." },
            { title: "Live EIA data", body: "Rates update automatically from EIA actuals. Always current." },
            { title: "Pre-load state", body: "Set ?state=california so your readers see local rates immediately." },
          ].map((f) => (
        ...
        <div className="bg-forest/5 border border-forest/25 rounded-2xl p-6">
          ...
          <p className="text-sm text-ink-3 leading-relaxed mb-4">
            Copy the code above or email us for custom integrations, white-label options, or co-branded versions.
          </p>
          <div className="flex flex-wrap gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold bg-transparent text-ink border border-line hover:border-forest/40 transition-all"
            >
              Contact us
            </a>
          </div>
